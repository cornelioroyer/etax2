...
class PrhCuota extends Model
{
    protected $table = 'prh_cuotas';
    ...
    {
        return $this->belongsTo(PrhUnidad::class, 'unidad_id');
    }

    public function tipoCuota(): BelongsTo
    {
        return $this->belongsTo(PrhTipoCuota::class, 'tipo_cuota_id');
    }

    public function pagos(): HasMany
    {
        return $this->hasMany(PrhPago::class, 'cuota_id');
    }
