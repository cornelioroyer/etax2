        ...
        <div
            x-data="{
                ...
                articles: [
                    ...
                    { id:12, cat:'cxp', title:'¿Cómo registrar una factura de proveedor?', body:'Ve a CxP → Facturas de Compras → Nueva factura. Selecciona el proveedor, ingresa el número de factura del proveedor, fecha y líneas de gasto o producto. Al confirmar, el sistema genera el asiento (débito Gasto e ITBMS Crédito, crédito CXP).' },
