    ...
    $groups = [
        ...
        [
            ...
            'children' => [
                ...
                ['label' => 'Registrar por QR / Foto', 'href' => route('admin.cxp.facturas.desde-cufe.form'), 'active' => request()->routeIs('admin.cxp.facturas.desde-cufe*'), 'show' => $can('cxp.gestionar') || $can('cxp.registrar_qr')],
            ],
        ],
        [
            'key' => 'ventas',
