@php
    ...
    $groups = [
        ...
        [
            ...
            'active' => request()->routeIs('admin.cuentas.*') || request()->routeIs('admin.asientos.*'),
        ...
        [
            ...
            'active' => request()->routeIs('admin.contactos.*') && request('tipo') === 'CLIENTE',
            'children' => [
                ...
                ['label' => 'Facturas', 'href' => null, 'active' => false, 'show' => $can('cxc.ver')],
                ['label' => 'Cobros', 'href' => null, 'active' => false, 'show' => $can('cxc.ver')],
                ['label' => 'Antigüedad de saldos', 'href' => null, 'active' => false, 'show' => $can('cxc.ver')],
            ],
        ],
        [
            'key' => 'cxp',
            ...
            'active' => request()->routeIs('admin.contactos.*') && request('tipo') === 'PROVEEDOR',
            'children' => [
                ...
                ['label' => 'Facturas por pagar', 'href' => null, 'active' => false, 'show' => $can('cxp.ver')],
                ['label' => 'Pagos', 'href' => null, 'active' => false, 'show' => $can('cxp.ver')],
                ['label' => 'Antigüedad de saldos', 'href' => null, 'active' => false, 'show' => $can('cxp.ver')],
            ],
        ],
        [
            'key' => 'compras',
        ...
        [
            ...
            'children' => [
                ['label' => 'Productos', 'href' => null, 'active' => false, 'show' => $can('inventario.ver')],
                ['label' => 'Movimientos', 'href' => null, 'active' => false, 'show' => $can('inventario.ver')],
            ],
        ],
        [
            'key' => 'activos',
