@php
    ...
    $groups = [
        ...
        [
            ...
            'href' => route('admin.asistente'),
            'active' => request()->routeIs('admin.asistente'),
        ...
        [
            ...
            'children' => [
                ...
                ['label' => 'Registrar por QR / CUFE', 'href' => route('admin.cxp.facturas.desde-cufe.form'), 'active' => request()->routeIs('admin.cxp.facturas.desde-cufe*'), 'show' => $can('cxp.gestionar') || $can('cxp.registrar_qr')],
            ],
        ],
        [
            'key' => 'ventas',
        ...
        [
            ...
            'active' => request()->routeIs('admin.cuentas.*') || request()->routeIs('admin.asientos.*') || request()->routeIs('admin.asientos-recurrentes.*') || request()->routeIs('admin.periodos.*') || request()->routeIs('admin.cuentas-default.*') || request()->routeIs('admin.plantillas-cuentas.*') || request()->routeIs('admin.diarios.*') || request()->routeIs('admin.cierre-anual.*') || request()->routeIs('admin.dimensiones.*'),
            ...
            'children' => [
                ...
                ['label' => 'Plantillas de cuentas', 'href' => route('admin.plantillas-cuentas.index'), 'active' => request()->routeIs('admin.plantillas-cuentas.*'), 'show' => Auth::user()->is_admin],
        ...
        [
            ...
            'active' => request()->routeIs('admin.edu.*'),
            'show' => $can('edu.ver'),
            'children' => [
                ['label' => 'Instituciones', 'href' => route('admin.edu.instituciones.index'), 'active' => request()->routeIs('admin.edu.instituciones.*'), 'show' => $can('edu.ver')],
                ['label' => 'Sedes', 'href' => route('admin.edu.sedes.index'), 'active' => request()->routeIs('admin.edu.sedes.*'), 'show' => $can('edu.ver')],
                ['label' => 'Configuración', 'href' => route('admin.edu.configuracion.index'), 'active' => request()->routeIs('admin.edu.configuracion.*'), 'show' => $can('edu.ver')],
                ['label' => 'Niveles académicos', 'href' => route('admin.edu.niveles.index'), 'active' => request()->routeIs('admin.edu.niveles.*'), 'show' => $can('edu.ver')],
                ['label' => 'Programas', 'href' => route('admin.edu.programas.index'), 'active' => request()->routeIs('admin.edu.programas.*'), 'show' => $can('edu.ver')],
                ['label' => 'Grados', 'href' => route('admin.edu.grados.index'), 'active' => request()->routeIs('admin.edu.grados.*'), 'show' => $can('edu.ver')],
                ['label' => 'Grupos', 'href' => route('admin.edu.grupos.index'), 'active' => request()->routeIs('admin.edu.grupos.*'), 'show' => $can('edu.ver')],
                ['label' => 'Períodos académicos', 'href' => route('admin.edu.periodos.index'), 'active' => request()->routeIs('admin.edu.periodos.*'), 'show' => $can('edu.ver')],
                ['label' => 'Asignaturas', 'href' => route('admin.edu.asignaturas.index'), 'active' => request()->routeIs('admin.edu.asignaturas.*'), 'show' => $can('edu.ver')],
                ['label' => 'Esquemas de calificación', 'href' => route('admin.edu.esquemas.index'), 'active' => request()->routeIs('admin.edu.esquemas.*'), 'show' => $can('edu.ver')],
                ['label' => 'Estudiantes', 'href' => route('admin.edu.estudiantes.index'), 'active' => request()->routeIs('admin.edu.estudiantes.*'), 'show' => $can('edu.ver')],
                ['label' => 'Docentes', 'href' => route('admin.edu.docentes.index'), 'active' => request()->routeIs('admin.edu.docentes.*'), 'show' => $can('edu.ver')],
                ['label' => 'Matrículas', 'href' => route('admin.edu.matriculas.index'), 'active' => request()->routeIs('admin.edu.matriculas.*'), 'show' => $can('edu.ver')],
                ['label' => 'Horarios', 'href' => route('admin.edu.horarios.index'), 'active' => request()->routeIs('admin.edu.horarios.*'), 'show' => $can('edu.ver')],
                ['label' => 'Evaluaciones', 'href' => route('admin.edu.evaluaciones.index'), 'active' => request()->routeIs('admin.edu.evaluaciones.*'), 'show' => $can('edu.ver')],
                ['label' => 'Asistencias', 'href' => route('admin.edu.asistencias.index'), 'active' => request()->routeIs('admin.edu.asistencias.*'), 'show' => $can('edu.ver')],
                ['label' => 'Conceptos de cobro', 'href' => route('admin.edu.conceptos-cobro.index'), 'active' => request()->routeIs('admin.edu.conceptos-cobro.*'), 'show' => $can('edu.ver')],
        ...
        [
            ...
            'active' => request()->routeIs('admin.users.*') || request()->routeIs('admin.roles.*') || request()->routeIs('admin.usuarios-compania.*') || request()->routeIs('admin.auditoria.*') || request()->routeIs('admin.respaldos.*'),
            'show' => Auth::user()->is_admin || $can('usuarios_compania.gestionar') || $can('respaldos.gestionar'),
            'children' => [
                ['label' => 'Usuarios', 'href' => route('admin.users.index'), 'active' => request()->routeIs('admin.users.*'), 'show' => Auth::user()->is_admin],
                ['label' => 'Roles', 'href' => route('admin.roles.index'), 'active' => request()->routeIs('admin.roles.*'), 'show' => Auth::user()->is_admin],
                ...
                ['label' => 'Respaldo de datos', 'href' => route('admin.respaldos.index'), 'active' => request()->routeIs('admin.respaldos.*'), 'show' => Auth::user()->is_admin || $can('respaldos.gestionar')],
