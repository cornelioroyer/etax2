<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Editar escenario</h2>
    ...
    <div class="py-8">
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white p-6 shadow-sm sm:rounded-lg">
                <form method="POST" action="{{ route('admin.presupuestos.escenarios.update', $escenario) }}">
                    @csrf @method('PUT')
                    <div>
                        <x-input-label for="nombre" value="Nombre del escenario *" />
                        <x-text-input id="nombre" name="nombre" type="text" class="mt-1 block w-full"
                            :value="old('nombre', $escenario->nombre)" required maxlength="150" />
                    </div>
