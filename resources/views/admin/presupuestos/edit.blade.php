<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Editar presupuesto</h2>
            <a href="{{ route('admin.presupuestos.show', $presupuesto) }}" class="text-sm text-gray-600 hover:text-gray-900">← Volver</a>
        </div>
    </x-slot>
            ...
            <div class="bg-white p-6 shadow-sm sm:rounded-lg">
                <form method="POST" action="{{ route('admin.presupuestos.update', $presupuesto) }}">
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <div>
                            ...
                            <x-text-input id="nombre" name="nombre" type="text" class="mt-1 block w-full"
                                :value="old('nombre', $presupuesto->nombre)" required maxlength="150" />
                        </div>
                        <div>
                    ...
                    <div class="mt-6 flex gap-3">
                        ...
                        <a href="{{ route('admin.presupuestos.show', $presupuesto) }}"
