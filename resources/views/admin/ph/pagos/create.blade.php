<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('admin.ph.cuotas.index') }}" class="text-sm text-gray-600 hover:text-gray-900">← Cuotas</a>
        </div>
    </x-slot>
    ...
    <div class="py-8">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white p-6 shadow-sm sm:rounded-lg">
                <form method="POST" action="{{ route('admin.ph.pagos.store') }}">
                    @csrf
                    ...
                    <div class="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <div>
                            ...
                            <select id="forma_pago" name="forma_pago" required
                                ...
                                @foreach (\App\Models\PhPago::FORMAS_PAGO as $fp)
                    ...
                    <div class="mt-6 flex gap-3">
                        ...
                        <a href="{{ route('admin.ph.cuotas.index') }}"
