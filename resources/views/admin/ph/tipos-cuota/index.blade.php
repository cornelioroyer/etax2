    ...
    <div class="py-8">
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8 space-y-4">
            ...
            <div class="bg-white p-6 shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('admin.ph.tipos-cuota.store') }}">
                    @csrf
                    ...
                    <div class="mt-3 grid grid-cols-1 gap-4 sm:grid-cols-3">
                        <div>
                            ...
                            <select id="periodicidad" name="periodicidad"
                                ...
                                @foreach (\App\Models\PhTipoCuota::PERIODICIDADES as $per)
                        ...
                        @forelse ($tipos as $t)
                            <tr x-data="{ edit: false }" class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-2 text-right space-x-2">
                                    ...
                                    <form method="POST" action="{{ route('admin.ph.tipos-cuota.destroy', $t) }}" class="inline"
                            ...
                            <tr x-show="edit" x-cloak>
                                <td colspan="7" class="bg-gray-50 px-4 py-3">
                                    <form method="POST" action="{{ route('admin.ph.tipos-cuota.update', $t) }}">
                                        @csrf @method('PUT')
