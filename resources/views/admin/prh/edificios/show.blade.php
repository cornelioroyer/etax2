    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <div class="flex gap-3 text-sm">
                <a href="{{ route('admin.prh.edificios.index') }}" class="text-gray-500 hover:text-gray-900">← Edificios</a>
                @can('prh.gestionar')
                    <a href="{{ route('admin.prh.edificios.edit', $edificio) }}" class="text-gray-600 hover:text-gray-900">Editar</a>
                    <a href="{{ route('admin.prh.edificios.unidades.create', $edificio) }}"
    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-4">
            ...
            <div class="bg-white shadow-sm sm:rounded-lg overflow-hidden">
                <div class="px-4 py-3 border-b border-gray-200 flex items-center justify-between">
                    ...
                    <div class="flex gap-3 text-xs text-gray-500">
                        <a href="{{ route('admin.prh.cuotas.index', ['edificio_id' => $edificio->id]) }}" class="text-indigo-600 hover:underline">Ver cuotas</a>
                        <a href="{{ route('admin.prh.pagos.index', ['edificio_id' => $edificio->id]) }}" class="text-indigo-600 hover:underline">Ver pagos</a>
                    </div>
                </div>
                        ...
                        @forelse ($edificio->unidades as $u)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-2 text-right space-x-2">
                                    <a href="{{ route('admin.prh.edificios.unidades.edit', [$edificio, $u]) }}" class="text-xs text-gray-600 hover:underline">Editar</a>
                                    <form method="POST" action="{{ route('admin.prh.edificios.unidades.destroy', [$edificio, $u]) }}" class="inline"
                        ...
                        @empty
                            <tr>
                                <td colspan="9" class="px-4 py-8 text-center text-gray-400">
                                    Sin unidades.
                                    @can('prh.gestionar')
                                        <a href="{{ route('admin.prh.edificios.unidades.create', $edificio) }}" class="text-indigo-600 hover:underline">Agregar la primera</a>
                                    @endcan
                                </td>
                            </tr>
                        @endforelse
            ...
            <div class="rounded-lg border border-red-200 bg-red-50 p-4">
                ...
                <form method="POST" action="{{ route('admin.prh.edificios.destroy', $edificio) }}"
