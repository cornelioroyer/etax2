<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('admin.prh.edificios.show', $edificio) }}" class="text-sm text-gray-600 hover:text-gray-900">← Ver edificio</a>
        </div>
    </x-slot>
    ...
    <div class="py-8">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white p-6 shadow-sm sm:rounded-lg">
                <form method="POST" action="{{ route('admin.prh.edificios.update', $edificio) }}">
                    @csrf @method('PUT')
