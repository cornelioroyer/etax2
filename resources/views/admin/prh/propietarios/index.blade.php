    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-4">
            ...
            <div class="bg-white p-6 shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('admin.prh.propietarios.store') }}">
                    @csrf
            ...
            <form method="GET" class="flex gap-2">
                ...
                @if ($search)
                    <a href="{{ route('admin.prh.propietarios.index') }}" class="rounded-md border border-gray-300 bg-white px-3 py-2 text-sm text-gray-700 hover:bg-gray-50">Limpiar</a>
                @endif
            </form>
                        ...
                        @forelse ($propietarios as $p)
                            <tr x-data="{ edit: false }" class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-2 text-right space-x-2">
                                    ...
                                    <form method="POST" action="{{ route('admin.prh.propietarios.destroy', $p) }}" class="inline"
                            ...
                            <tr x-show="edit" x-cloak>
                                <td colspan="7" class="bg-gray-50 px-4 py-3">
                                    <form method="POST" action="{{ route('admin.prh.propietarios.update', $p) }}">
                                        @csrf @method('PUT')
