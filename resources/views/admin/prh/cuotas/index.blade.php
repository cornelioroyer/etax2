    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <div class="flex gap-3 text-sm">
                ...
                @can('prh.gestionar')
                    <a href="{{ route('admin.prh.cuotas.generar') }}"
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-4">
            ...
            <form method="GET" class="bg-white p-4 shadow-sm sm:rounded-lg">
                ...
                <div class="mt-3 flex gap-2">
                    ...
                    <a href="{{ route('admin.prh.cuotas.index') }}" class="rounded-md border border-gray-300 bg-white px-3 py-2 text-sm text-gray-700 hover:bg-gray-50">Limpiar</a>
                </div>
            </form>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-2 text-right space-x-2 whitespace-nowrap">
                                    @if ($c->estado !== 'ANULADO' && $c->estado !== 'PAGADO')
                                        <a href="{{ route('admin.prh.pagos.create', ['cuota_id' => $c->id]) }}"
                                            class="text-xs text-green-700 hover:underline">Registrar pago</a>
                                        <form method="POST" action="{{ route('admin.prh.cuotas.anular', $c) }}" class="inline"
                        ...
                        @empty
                            <tr>
                                <td colspan="10" class="px-4 py-12 text-center text-gray-400">
                                    Sin cuotas.
                                    @can('prh.gestionar')
                                        <a href="{{ route('admin.prh.cuotas.generar') }}" class="text-indigo-600 hover:underline">Generar cuotas</a>
                                    @endcan
                                </td>
                            </tr>
                        @endforelse
