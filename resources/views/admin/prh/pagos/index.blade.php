    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <div class="flex gap-3 text-sm">
                ...
                @can('prh.gestionar')
                    <a href="{{ route('admin.prh.pagos.create') }}"
    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-4">
            ...
            <form method="GET" class="flex flex-wrap gap-3 items-end">
                ...
                <a href="{{ route('admin.prh.pagos.index') }}" class="rounded-md border border-gray-300 bg-white px-3 py-2 text-sm text-gray-700 hover:bg-gray-50">Limpiar</a>
            </form>
                        ...
                        @forelse ($pagos as $p)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-2 text-right">
                                    <form method="POST" action="{{ route('admin.prh.pagos.destroy', $p) }}" class="inline"
