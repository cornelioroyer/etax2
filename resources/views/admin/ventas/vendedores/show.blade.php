<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Vendedor {{ $vendedor->codigo }}</h2>
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-4">
            ...
            <div class="bg-white shadow-sm sm:rounded-lg p-6">
                <div class="grid grid-cols-2 gap-4 text-sm">
                    <div><span class="text-gray-500">Código</span><p class="font-mono font-bold">{{ $vendedor->codigo }}</p></div>
                    ...
                    <div class="col-span-2"><span class="text-gray-500">Contacto</span><p class="font-medium">{{ $vendedor->contacto?->nombre ?? '—' }}</p></div>
                </div>
            </div>
