<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Importando facturas de venta desde la DGI</h2>
    </x-slot>

    <div class="py-8">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8"
             x-data="importProgreso({{ $importacion->id }}, '{{ route('admin.ventas.facturas.importar.estado', $importacion) }}', '{{ route('admin.ventas.facturas.index') }}')"
             x-init="iniciar()">
