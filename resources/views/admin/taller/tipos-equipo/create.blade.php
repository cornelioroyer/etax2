<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Nuevo tipo de equipo</h2>
            <a href="{{ route('admin.taller.tipos-equipo.index', $tallerId ? ['taller_id' => $tallerId] : []) }}" class="text-sm text-gray-600 hover:text-gray-900">← Tipos de equipo</a>
        </div>
    </x-slot>
    ...
    <div class="py-8">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white p-6 shadow-sm sm:rounded-lg">
                <form method="POST" action="{{ route('admin.taller.tipos-equipo.store') }}">
                    @csrf
                    <div>
                    ...
                    <div class="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
                        ...
                        <div>
                            <x-input-label for="unidad_medidor" value="Unidad de medidor (si aplica)" />
                            <x-text-input id="unidad_medidor" name="unidad_medidor" type="text" class="mt-1 block w-full"
                                :value="old('unidad_medidor')" maxlength="30" placeholder="km, horas, ciclos..." />
                        </div>
                    </div>
                    <div class="mt-4">
                    ...
                    <div class="mt-6 flex gap-3">
                        ...
                        <a href="{{ route('admin.taller.tipos-equipo.index', $tallerId ? ['taller_id' => $tallerId] : []) }}"
