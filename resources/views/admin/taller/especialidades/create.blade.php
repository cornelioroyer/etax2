<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('admin.taller.especialidades.index', $tallerId ? ['taller_id' => $tallerId] : []) }}" class="text-sm text-gray-600 hover:text-gray-900">← Especialidades</a>
        </div>
    </x-slot>
    ...
    <div class="py-8">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white p-6 shadow-sm sm:rounded-lg">
                <form method="POST" action="{{ route('admin.taller.especialidades.store') }}">
                    @csrf
                    <div>
                    ...
                    <div class="mt-6 flex gap-3">
                        ...
                        <a href="{{ route('admin.taller.especialidades.index', $tallerId ? ['taller_id' => $tallerId] : []) }}"
